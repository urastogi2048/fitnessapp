...
class RecoveryReadiness {
  ...
  String get message {
    if (overallscore >= 80)
      return 'You\'re fully recovered! Go for a challenging workout ';
    if (overallscore >= 60)
      return 'Good recovery. Moderate intensity workout recommended ';
    if (overallscore >= 40)
      return 'Below optimal recovery. Light activity recommended ';
...
class RecoveryService {
  ...
  Future<RecoveryReadiness> fetchRecoveryReadiness(
...
final recoveryReadinessProvider = FutureProvider.autoDispose
    .family<RecoveryReadiness, Map<String, dynamic>>((ref, userMetrics) async {
